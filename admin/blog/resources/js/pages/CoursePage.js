...
class CoursePage extends Component {
    ...
    componentDidMount() {
        Axios.get('/selectCourses').then((response)=>{
    ...
    onDataDelete(){
        ...
        if (permission === true){
            ...
            Axios.post('/deleteCourses', {id:rowId}).then((response)=>{
    ...
    render() {
        ...
        const columns = [
            ...
            {dataField:'small_img', text:'Image', formatter:this.imgFormatting},
            {dataField:'sort_title', text:'Sort Title'},
            {dataField:'sort_des', text:'Sort Des'},
                        ...
                        <Container fluid={true} >
                            <Row>
                                <Col sm={12} md={12} lg={12} >
                                    ...
                                    <Button onClick={this.addNewModalOpen} className="normal-btn btn p-2 mt-3" >Add Course</Button>
                                    <Card>
                                        <Card.Body>
                                            <BootstrapTable
                                                keyField='id'
                        ...
                        <Modal.Body>
                            ...
                            <Form>
                                <Form.Group>
                                    ...
                                    <Form.Control id="" type="text" placeholder="Enter Client Name" />
                                </Form.Group>
                                <Form.Group>
                                ...
                                <Form.Group>
                                    <Form.Label>Courses Image</Form.Label>
