...
class ProjectPage extends Component {
    ...
    componentDidMount() {
        Axios.get('/selectProject').then((response)=>{
    ...
    onDataDelete(){
        ...
        if (permission === true){
            ...
            Axios.post('/deleteProject', {id:rowId}).then((response)=>{
    ...
    render() {
        ...
        const columns = [
            ...
            {dataField:'project_font_img', text:'Image', formatter:this.imgFormatting},
            {dataField:'project_name', text:'Project Title'},
            {dataField:'project_short_description', text:'Sort Description'},
            {text: "Actions"},
        ];
        const selectRow ={
            mode:"radio",
                        ...
                        <Container fluid={true} >
                            <Row>
                                <Col sm={12} md={12} lg={12} >
                                    ...
                                    <Button onClick={this.addNewModalOpen} className="normal-btn btn p-2 mt-3" >Add Project</Button>
                                    <Card>
                                        <Card.Body>
                                            <BootstrapTable
                                                keyField='id'
